 ...
 */
#ifndef ADC_VCAL_Q16_H
#define ADC_VCAL_Q16_H
#include <stdint.h>
#include "fixed_q16.h"

typedef struct
{
	q16_t v_ref_in; /* PA0 基準電圧 [V] */
	q16_t v_per_lsb; /* 1 LSB あたり電圧 [V/LSB] */
	q16_t alpha; /* IIR 係数 0..1 */
...
static inline q16_t adc_vcal_get_v_per_lsb(const adc_vcal_t *s)
{
	return s->v_per_lsb;
}
