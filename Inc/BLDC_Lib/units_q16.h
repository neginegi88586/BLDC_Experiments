...
#define UQ_RSHUNT_OHM q16_16_from_frac(5, 100)   /* 0.05Ω */
#define UQ_AMP_GAIN   q16_16_from_int(10)     /* x10   */
#define UQ_VOFFSET_V  q16_16_from_frac(165, 100) /* 1.65V */
...
/* 角速度の相互変換 */
#define UQ_TWO_PI q16_16_from_frac(710, 113) /* ≈ 2π */
#define UQ_60     q16_16_from_int(60)
